package com.example.support.healthy_134.sleep;
...
import com.example.support.healthy_134.dbhelper.DBHelper;
...
public class SleepFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        date = findViewById(R.id.sleep_date);
        bedTime = findViewById(R.id.sleep_start);
        wakingTime = findViewById(R.id.sleep_end);
        saveButton = findViewById(R.id.sleep_save);
